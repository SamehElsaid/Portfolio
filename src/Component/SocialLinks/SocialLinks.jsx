    ...
    return (
        <div>
            <ul className=" items-center gap-5 flex flex-wrap">
                <a href='https://www.facebook.com/profile.php?id=100006920683098' 
                target="_blank" rel="noreferrer" className="capitalize relative text-[20px] group w-9 h-9 hover:translate-y-[12px] hover:scale-[0.8] flex items-center justify-center  hover:rotate-[-35deg] hover:skew-x-[20deg]  rounded-md hover:skew-y-[20deg] text-white  cursor-pointer duration-500  ">
                ...
                <a href='https://github.com/samehElsaid' 
                target="_blank" rel="noreferrer" className="capitalize relative text-[20px] group w-9 h-9 hover:translate-y-[12px] hover:scale-[0.8] flex items-center justify-center  hover:rotate-[-35deg] hover:skew-x-[20deg]  rounded-md hover:skew-y-[20deg] text-white  cursor-pointer duration-500  ">
                ...
                <a href='https://contacts.google.com/person/c3734090081087120487?hl=en' 
                target="_blank" rel="noreferrer" className="capitalize relative text-[20px] group w-9 h-9 hover:translate-y-[12px] hover:scale-[0.8] flex items-center justify-center  hover:rotate-[-35deg] hover:skew-x-[20deg]  rounded-md hover:skew-y-[20deg] text-white  cursor-pointer duration-500  ">
                ...
                <a href='https://api.whatsapp.com/send/?phone=01558290662&text&type=phone_number&app_absent=0' 
                target="_blank" rel="noreferrer" className="capitalize relative text-[20px] group w-9 h-9 hover:translate-y-[12px] hover:scale-[0.8] flex items-center justify-center  hover:rotate-[-35deg] hover:skew-x-[20deg]  rounded-md hover:skew-y-[20deg] text-white  cursor-pointer duration-500  ">
                ...
                <a href='https://www.linkedin.com/in/sameh-elsaid-elmeligy/' 
                target="_blank" rel="noreferrer" className="capitalize relative text-[20px] group w-9 h-9 hover:translate-y-[12px] hover:scale-[0.8] flex items-center justify-center  hover:rotate-[-35deg] hover:skew-x-[20deg]  rounded-md hover:skew-y-[20deg] text-white  cursor-pointer duration-500  ">
